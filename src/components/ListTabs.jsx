  ...
  return (
    <div className="w-80 flex flex-col border-r border-white/5 shrink-0 h-full">
      <div className="p-8 pb-0 mb-6">
        <img
          src="/01_Netflix_Logo/01_Netflix_Logo/01_Netflix_Logo_RGB/Netflix_Logo_RGB.png"
          alt="Netflix"
          className="w-32 mb-10 object-contain"
        />
      ...
      <div className="flex items-center gap-2 mb-2 ">
        <h3 className="text-gray-400 font-medium text-sm uppercase px-6 tracking-wider">
          New Trailers
        </h3>
      ...
      <div className="flex-1 p-8 mt-4 overflow-y-auto no-scrollbar">
        <div className="flex flex-col gap-4 pb-4">
          <a
            href="https://www.youtube.com/watch?v=Xf0ZWb3-5MY"
            target="_blank"
          ...
          >
            ...
            <div className="mt-2 flex justify-between items-center px-1">
              <span className="text-gray-300 text-xs font-medium group-hover:text-white transition">
                One Piece
              </span>
